...
import getNoiseValueAtCoord, { NoiseOptions } from '../utils/getNoiseValueAtCoord'
 ...
 */
export default function useNoisyVertices({ seed, resolution }: NoisyVerticesControls, noiseOptions: NoiseOptions, planeSize = 200) {
